...
/**
 * Weather ability affecting ranged units
 */
public class Fog implements Ability {
    ...
    public void activate(GameState gamestate) {
        List<Card> player1Board = gamestate.getPlayerOne().getCardsInZone(CardType.RANGE);
        List<Card> player2Board = gamestate.getPlayerTwo().getCardsInZone(CardType.RANGE);
     ...
     * Sets the strength of all ranged units to their base strength
    ...
    public String getDescription() {
        return "Sets the strength of all ranged units to 1";
    }
}
