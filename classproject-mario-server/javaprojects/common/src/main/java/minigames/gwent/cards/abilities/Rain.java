...
/**
 * Weather ability affecting siege units
 */
public class Rain implements Ability {
    ...
    public void activate(GameState gamestate) {
        List<Card> player1Board = gamestate.getPlayerOne().getCardsInZone(CardType.SIEGE);
        List<Card> player2Board = gamestate.getPlayerTwo().getCardsInZone(CardType.SIEGE);
     ...
     * Sets the strength of all siege units to their base strength
    ...
    public String getDescription() {
        return "Sets the strength of all siege units to 1";
    }
