...
import minigames.client.geowars.gameobjects.enemies.SmallPinkEnemy;

import java.awt.*;

public class SmallPinkEnemyDrawing extends Drawing {

  public SmallPinkEnemyDrawing(GameObject parent) {
    super(parent);
  ...
  public void draw(Graphics g, double scale, double rotation, Color customColor) {
    ...
    // Set the scale
    int width = (int) (SmallPinkEnemy.DEFAULT_WIDTH * scale);
